...
import com.lazite.assist.produce.util.FileUtils;

public class ControllerProduce implements Pi{
	private FilePo filePo;
	
	
	public void produce() throws Exception {				
		String s=FreeMarkers.getFtlString(this.getResourceBufferedReader("/com/lazite/assist/produce/jpa/ftl/single/controller.ftl"),
